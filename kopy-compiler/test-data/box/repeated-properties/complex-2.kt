...
fun box(): String {
    ...
    val foo2 = foo0.copy {
        ...
        quz.text.set("Changed 5")
        bar.baz.quz.text.set("Changed 6")
    }
    val isOneOk = foo2.bar.quz.text == "Changed 4"
    val isTwoOk = foo2.quz.text == "Changed 5"
    val isThreeOk = foo2.bar.baz.quz.text == "Changed 6"
