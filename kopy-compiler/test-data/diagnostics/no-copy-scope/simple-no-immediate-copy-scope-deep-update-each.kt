...
fun diagnostics() {
    ...
    val foo21 = foo0 copy {
        foo0.apply { bar.baz.qux.numbers.<!NO_COPY_SCOPE!>updateEach<!> { it + 42 } }
    }

    val foo22 = foo0 copy {
        apply { bar.baz.qux.numbers.<!NO_COPY_SCOPE!>updateEach<!> { it + 42 } }
    }

    val foo23 = foo0 copy {
        bar.baz.qux.numbers.updateEach { it + 42 }
    }
}

data class Qux(val numbers: List<Int>)
