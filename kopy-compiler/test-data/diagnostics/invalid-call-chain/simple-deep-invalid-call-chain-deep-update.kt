...
fun diagnostics() {
    ...
    val foo10 = foo0 { <!INVALID_CALL_CHAIN!>bar0<!>.baz.qux.number.update { it + 42 } }
    val foo11 = foo0 copy { <!INVALID_CALL_CHAIN!>bar0<!>.baz.qux.number.update { it + 42 } }

    val foo20 = foo0 { bar.baz.<!INVALID_CALL_CHAIN!>apply<!> {}.qux.number.update { it + 42 } }
    val foo21 = foo0 copy { bar.baz.<!INVALID_CALL_CHAIN!>apply<!> {}.qux.number.update { it + 42 } }
}
